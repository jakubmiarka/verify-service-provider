...
public class ComplianceToolV2InitialisationRequestBuilder {
    ...
    private MatchingDataset matchingDataset = new MatchingDataset(new MatchingAttribute("Bob", true,
            LocalDate.now().minusDays(30).toDateTimeAtCurrentTime(), LocalDate.now().toDateTimeAtCurrentTime()),
            null, singletonList(new MatchingAttribute("Smith", true,
            LocalDate.now().minusDays(30).toDateTimeAtCurrentTime(), LocalDate.now().toDateTimeAtCurrentTime())),
            new MatchingAttribute("NOT_SPECIFIED", true, LocalDate.now().minusDays(30).toDateTimeAtCurrentTime(), LocalDate.now().toDateTimeAtCurrentTime()),
            null, singletonList(new MatchingAddress(true, LocalDate.now().minusDays(30).toDateTimeAtCurrentTime(), LocalDate.now().toDateTimeAtCurrentTime(),
            "E1 8QS", Arrays.asList("The White Chapel Building" ,"10 Whitechapel High Street"), null, null)), UUID.randomUUID().toString());
